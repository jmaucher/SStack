...
namespace SStack.WebHost.Endpoints
{
    public class EndpointHostConfig
    {
        ...
        public static string SStackPath = null;
        ...
        public static EndpointHostConfig Instance
        {
            get
            {
                if (instance == null)
                {
                    ...
                    {
                        MetadataTypesConfig = new MetadataTypesConfig(addDefaultXmlNamespace: "http://schemas.SStack.net/types"),
                        WsdlServiceNamespace = "http://schemas.SStack.net/types",
                        WsdlSoapActionNamespace = "http://schemas.SStack.net/types",
                        MetadataPageBodyHtml = @"<br />
                            <h3><a href=""https://github.com/SStack/SStack/wiki/Clients-overview"">Clients Overview</a></h3>",
                        ...
                        SStackHandlerFactoryPath = SStackPath,
                        ...
                        CustomHttpHandlers = new Dictionary<HttpStatusCode, ISStackHttpHandler>(),
                    ...
                    if (instance.SStackHandlerFactoryPath == null)
                    {
        ...
        public EndpointHostConfig()
        {
            ...
            this.SStackHandlerFactoryPath = instance.SStackHandlerFactoryPath;
        ...
        const string NamespacesAppSettingsKey = "SStack.razor.namespaces";
        ...
        public static HashSet<string> RazorNamespaces
        {
            get
            {
                ...
                //E.g. <add key="SStack.razor.namespaces" value="System,SStack.Text" />
            ...
            try
            {
                ...
                if (!SkipPathValidation && instance.MetadataRedirectPath == null)
                {
                    throw new ConfigurationErrorsException(
                        "Unable to infer SStack's <httpHandler.Path/> from the Web.Config\n"
                        + "Check with http://www.SStack.net/SStack.Hello/ to ensure you have configured SStack properly.\n"
                        + "Otherwise you can explicitly set your httpHandler.Path by setting: EndpointHostConfig.SStackPath");
                }
            }
            catch (Exception) { }
        }
        ...
        private static void SetPathsFromConfiguration(System.Configuration.Configuration config, string locationPath)
        {
            ...
            if (handlersSection != null)
            {
                for (var i = 0; i < handlersSection.Handlers.Count; i++)
                {
                    ...
                    if (!httpHandler.Type.StartsWith("SStack"))
                        continue;
        ...
        private static void SetPaths(string handlerPath, string locationPath)
        {
            ...
            instance.SStackHandlerFactoryPath = locationPath ??
                (String.IsNullOrEmpty(handlerPath) ? null : handlerPath);

            instance.MetadataRedirectPath = PathUtils.CombinePaths(
                null != locationPath ? instance.SStackHandlerFactoryPath : handlerPath
                , "metadata");
        }
        ...
        private static string ExtractHandlerPathFromWebServerConfigurationXml(string rawXml)
        {
            return XDocument.Parse(rawXml).Root.Element("handlers")
                .Descendants("add")
                .Where(handler => EnsureHandlerTypeAttribute(handler).StartsWith("SStack"))
        ...
        public string SStackHandlerFactoryPath { get; set; }
        ...
        public Dictionary<HttpStatusCode, ISStackHttpHandler> CustomHttpHandlers { get; set; }
        public ISStackHttpHandler GlobalHtmlErrorHttpHandler { get; set; }
        ...
        public ISStackHttpHandler GetHandlerForErrorStatus(HttpStatusCode errorStatus)
        {
        ...
        public ISStackHttpHandler GetCustomErrorHandler(int errorStatusCode)
        {
            try
            {
        ...
        public ISStackHttpHandler GetCustomErrorHandler(HttpStatusCode errorStatus)
        {
            ISStackHttpHandler httpHandler = null;
            if (CustomHttpHandlers != null)
            {
        ...
        public IHttpHandler GetCustomErrorHttpHandler(HttpStatusCode errorStatus)
        {
            ...
            return httpHandler ?? new SStackHttpHandler(ssHandler);
        }
