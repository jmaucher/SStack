...
namespace SStack.WebHost.Endpoints
{
    public class ServiceEndpointsMetadataConfig
    {
        ...
        /// <summary>
        /// Changes the links for the SStack/metadata page
        /// </summary>
        /// <param name="SStackHandlerPrefix"></param>
        /// <returns></returns>
        public static ServiceEndpointsMetadataConfig Create(string SStackHandlerPrefix)
        {
