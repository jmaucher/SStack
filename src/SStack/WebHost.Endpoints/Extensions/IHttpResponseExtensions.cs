...
using SStack.MiniProfiler;
using SStack.Service;
using SStack.ServiceHost;
using SStack.ServiceInterface.ServiceModel;
using SStack.Text;

namespace SStack.WebHost.Endpoints.Extensions
{
    public static class HttpResponseExtensions
    {
        ...
        /// <param name="result">Whether or not it was implicity handled by SStack's built-in handlers.</param>
        ...
        public static bool WriteToResponse(this IHttpResponse response, object result, ResponseSerializerDelegate defaultAction, IRequestContext serializerCtx, byte[] bodyPrefix, byte[] bodySuffix)
        {
            using (Profiler.Current.Step("Writing to Response"))
            {
                ...
                catch (Exception originalEx)
                {
                    ...
                    //DB: Using standard SStack configuration method
        ...
        public static void EndSStackRequest(this HttpResponse httpRes, bool skipHeaders = false)
        {
            httpRes.EndRequest(skipHeaders);
        }

        [Obsolete("Use EndRequest extension method")]
        public static void EndSStackRequest(this IHttpResponse httpRes, bool skipHeaders = false)
        {
            httpRes.EndRequest(skipHeaders);
        }
