...
//			typeof(XmlDocument).Assembly,  //"system.xml.dll",
			...
			typeof(AppHostBase).Assembly,  //"SStack.dll",
			typeof(JsConfig).Assembly,     //"SStack.Text.dll",
			typeof(IService<>).Assembly,   //"SStack.Interfaces.dll",
			typeof(Common.UrnId).Assembly, //"SStack.Common.dll"
		};
