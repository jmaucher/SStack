...
namespace SStack.WebHost.Endpoints.Support
{
		...
		: ISStackHttpHandler, IHttpHandler
	{
		...
		public void ProcessRequest(IHttpRequest httpReq, IHttpResponse httpRes, string operationName)
		{
			...
			response.HandlerFactoryArgs = SStackHttpHandlerFactory.DebugLastHandlerArgs;
		...
		public static RequestInfoResponse GetRequestInfo(IHttpRequest httpReq)
		{
			...
			{
				Host = EndpointHost.Config.DebugHttpListenerHostEnvironment + "_v" + Env.SStackVersion + "_" + EndpointHost.Config.ServiceName,
