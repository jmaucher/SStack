...
namespace SStack.WebHost.Endpoints.Formats
{
	public class HtmlFormat : IPlugin
	{
		...
		public static string HtmlTitleFormat
			= @"Snapshot of <i>{0}</i> generated by <a href=""http://www.SStack.net"">SStack</a> on <b>{1}</b>";
		...
		{
			AppHost = appHost;
			//Register this in SStack with the custom formats
		...
		{
			// SStack.WebHost.Endpoints.Formats.HtmlFormat.html
