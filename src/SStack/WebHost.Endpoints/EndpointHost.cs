...
using SStack.CacheAccess.Providers;
using SStack.Common;
...
using SStack.WebHost.Endpoints.Utils;
...
namespace SStack.WebHost.Endpoints
{
    public class EndpointHost
    {
        ...
        {
            config.ServiceEndpointsMetadataConfig = ServiceEndpointsMetadataConfig.Create(config.SStackHandlerFactoryPath);
        ...
        public static void AfterInit()
        {
            ...
            if (config.SStackHandlerFactoryPath != null)
                config.SStackHandlerFactoryPath = config.SStackHandlerFactoryPath.TrimStart('/');
        ...
        /// <summary>
        /// Call to signal the completion of a SStack-handled Request
        /// </summary>
