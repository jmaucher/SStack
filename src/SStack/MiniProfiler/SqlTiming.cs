...
using SStack.MiniProfiler.Data;
...
namespace SStack.MiniProfiler
{
    ...
    public class SqlTiming
    {
        ...
        /// <summary>
        /// Called when database reader is closed, ending profiling for <see cref="SStack.MiniProfiler.Data.ExecuteType.Reader"/> SqlTimings.
        /// </summary>
