...
using System.Web;
using SStack.Text;
using SStack.MiniProfiler.Helpers;
...
using HttpResponseWrapper = SStack.WebHost.Endpoints.Extensions.HttpResponseWrapper;

namespace SStack.MiniProfiler.UI
{
	/// <summary>
	/// Understands how to route and respond to MiniProfiler UI urls.
	/// </summary>
	public class MiniProfilerHandler : /*IRouteHandler, */ IHttpHandler, ISStackHttpHandler
	{
...
<script type=""text/javascript"">
    jQuery(function() {{
		...
		private static string GetResource(string filename)
		{
			...
			{
				using (var stream = typeof(MiniProfilerHandler).Assembly.GetManifestResourceStream("SStack.MiniProfiler.UI." + filename))
