...
using FastMember = SStack.Text.FastMember;
#endif
...
namespace SStack
{
    public class Net40PclExport : PclExport
    {
        ...
        public const string AppSettingsKey = "SStack:license";
        public const string EnvironmentKey = "SStack_LICENSE";
        ...
        public override void RegisterLicenseFromConfig()
        {
            ...
            //or SStack_LICENSE Environment variable
...
namespace SStack.Text.FastMember
{
    /// <summary>
