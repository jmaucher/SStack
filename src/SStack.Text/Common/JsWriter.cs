...
namespace SStack.Text.Common
{
    public static class JsWriter
    {
        ...
        private static readonly SStackTypeCode[] knownCodes = new SStackTypeCode[] {
            SStackTypeCode.Boolean, SStackTypeCode.Char, SStackTypeCode.SByte, SStackTypeCode.Byte,
            SStackTypeCode.Int16, SStackTypeCode.UInt16, SStackTypeCode.Int32, SStackTypeCode.UInt32,
            SStackTypeCode.Int64, SStackTypeCode.UInt64, SStackTypeCode.Single, SStackTypeCode.Double,
            SStackTypeCode.Decimal, SStackTypeCode.String,
            SStackTypeCode.DateTime, SStackTypeCode.TimeSpan, SStackTypeCode.Guid, SStackTypeCode.Uri,
            SStackTypeCode.ByteArray, SStackTypeCode.Type
        };

        internal enum SStackTypeCode
        {
            Empty = 0,
        ...
        private static SStackTypeCode GetTypeCode(Type type)
        {
            int idx = Array.IndexOf<Type>(knownTypes, type);
            if (idx >= 0) return knownCodes[idx];
            return type == null ? SStackTypeCode.Empty : SStackTypeCode.Unknown;
        }
#endif
